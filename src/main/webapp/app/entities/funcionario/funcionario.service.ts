...
export class FuncionarioService {
  ...
  protected convertDateFromClient(funcionario: IFuncionario): IFuncionario {
    const copy: IFuncionario = Object.assign({}, funcionario, {
      ...
      dataDesligamento:
        funcionario.dataDesligamento && funcionario.dataDesligamento.isValid()
          ? funcionario.dataDesligamento.format(DATE_FORMAT)
          : undefined,
      dataHoraCadastro:
        funcionario.dataHoraCadastro && funcionario.dataHoraCadastro.isValid() ? funcionario.dataHoraCadastro.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.dataDesligamento = res.body.dataDesligamento ? moment(res.body.dataDesligamento) : undefined;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((funcionario: IFuncionario) => {
        ...
        funcionario.dataDesligamento = funcionario.dataDesligamento ? moment(funcionario.dataDesligamento) : undefined;
        funcionario.dataHoraCadastro = funcionario.dataHoraCadastro ? moment(funcionario.dataHoraCadastro) : undefined;
      });
    }
    return res;
  }
